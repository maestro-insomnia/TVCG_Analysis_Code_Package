# Run Example 2 using synthetic data with alternative factor and outcome names.
...
run_analysis(file.path(script_dir, "configs", "Config_Example_2_Alternative_Names.R"))
